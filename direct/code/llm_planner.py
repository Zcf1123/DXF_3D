...
Parses Markdown prompt files in `DXF_3D/direct/prompts/`, and exposes:
...
from ...llm_client import LLMClient, Prompt, load_prompt_from_dir, render_template
